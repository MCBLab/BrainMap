...
\item \textbf{On-demand scoring of user-submitted gene lists.} A user may paste
      ...
      developmental map. In the same time, import the log2 fold-change values from an external comparison — a different disease model, treatment, or condition — and plot them against the BrainSpan expression data. This lets you run analyses along directions the dataset wasn't originally built for, not just the comparisons already included in it.
...
VEGABrain opens on a single working page with a control
