...
#* @serializer png list(width = 1600, height = 600, res = 150) 
#* @get /plot_brain
function(gene = "SOX10") { 
  ...
  p <- ggplot() +
    geom_brain(
      ...
      atlas = dk,
      hemi = "right",
      # Removido o position_brain() problemático
    ...
    theme(
      ...
      strip.text = element_text(size = 14, face = "bold", margin = margin(b = 10, t = 2)),
...
#* @serializer png list(width = 1600, height = 500, res = 150)
#* @get /plot_ontology
